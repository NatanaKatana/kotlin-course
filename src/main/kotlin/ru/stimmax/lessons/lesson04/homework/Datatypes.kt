...
//val v6 = FALSE //неккоректно - необходимо писать маленькими буквами
...
val v19: Float = 5.75f
//val v20 = `1.414` // некорректно - неправильные одинарные кавычки, в Char для одинарных кавычек предполагается один знак - тут слишком длинное значение
...
//val v30 = FALSE//неккоректно - необходимо писать маленькими буквами
val v30: Boolean = false
val v31: Double = 0.007
val v32: String = "🤯"
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
//val v34 = ‘65535’ // одинарные кавычки для Чара - но чар предполагает собой один знак, поэтому если и кавычки, то двойные
...
//val v44 = TRUE //неккоректно - необходимо писать маленькими буквами
val v45: Boolean = true
...
//val s4: List<String> = listOf("список расходов")

// 4. Хранить длину очереди в столовой до миллиардной доли сантиметра.
val s4: Double = 0.000000001
...
val s12: List<String> = listOf("список тем для митингов, которые на самом деле никому не нужны")
