...
var participantsCount: Int = 338

// 5. Количество участников (публичная переменная неизвестная на момент написания)
lateinit var participantsCount: Int = 338
...
// 21. Политика конфиденциальности (неизменяемая приватная переменная известная на момент написания)
