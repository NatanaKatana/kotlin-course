...
//23. Взять последние 3 элемента списка
    ...
    println(ex24(listOf(3, 4, 5, 6, 6, 6, 6, 6)))
    println(ex25(listOf(85, 58, 90, 74, 88, 67, 95, 92, 50, 42, 12)))
    println(
        ex26(
            listOf(
                "Стол",
    ...
    println(ex28(listOf(1, 3, 5, 7, 3, 1, 8, 9, 9, 7)))
    println(ex29(listOf(22, 18, 30, 45, 17, null, 60), 18))
}
